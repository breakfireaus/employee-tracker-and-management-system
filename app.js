        ...
        async function (err2, rawRoles) {
          ...
          connection.query(
            ...
            async function (err3, rawManagers) {
              ...
              const response = await inquirer.prompt([
                {
                  ...
                  name: 'manager',
                  message:
                    'Please select a manager that the employee will report to.',
                  choices: managers,
                },
                {
                  type: 'input',
              ...
              connection.query(completeInsert, function (err4, res) {
                if (err4) throw err4;
                console.log(
...
async function deleteAnEmployee() {
  connection.query(
    ...
    async function (err, res) {
      ...
      connection.query(
        `DELETE FROM employees WHERE id = '${res[index].id}'`,
        function (err2, res2) {
          if (err2) throw err2;
...
async function deleteARole() {
  connection.query('SELECT * FROM roles', async function (err, res) {
    ...
    connection.query(
      `DELETE FROM roles WHERE id = '${res[index].id}'`,
      function (err2, res2) {
        if (err2) throw err2;
...
async function deleteADepartment() {
  connection.query(
    ...
    async function (err, res) {
      ...
      connection.query(
        `DELETE FROM departments WHERE department_name = '${response.department}';`,
        function (err2, res2) {
          if (err2) throw err2;
